...
SYSTEM_PROMPT = (
    ...
    "3. **Analyze & Execute:** Based on your plan, use `SearchText`, `Edit`, `WriteFile`, or `Shell` to execute the steps. Use `SaveMemory` to remember key findings.\n"
    "4. **Consult Web:** Use `WebFetch` if you need external information.\n\n"
    "**Tool Guidelines:**\n"
